...
two_tick_wait_time_mean = np.random.uniform(.7,1.6)
two_tick_wait_time_stdDev = two_tick_wait_time_mean/10

three_tick_wait_time_mean = np.random.uniform(1.2,2.5)
three_tick_wait_time_stdDev = three_tick_wait_time_mean/10
